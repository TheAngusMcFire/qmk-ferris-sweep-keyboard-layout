...
tap_dance_action_t tap_dance_actions[] = {
  [TD_ESC_H]  = ACTION_TAP_DANCE_DOUBLE(KC_SCLN, KC_ESC)
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,            KC_Y,    KC_U,  KC_I,    KC_O,   KC_P,
    KC_CTLA, MT(MOD_LALT, KC_S), MT(MOD_LCTL, KC_D), MT(MOD_LGUI, KC_F),    KC_G, KC_H,    MT(MOD_RGUI, KC_J),    MT(MOD_RCTL, KC_K),    MT(MOD_RALT, KC_L),   TD(TD_ESC_H),
  ...
  [1] = LAYOUT(
    ...
    QK_GESC, KC_HOME, KC_PGDN, KC_PGUP, CW_TOGG,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT,
